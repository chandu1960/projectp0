...
<div class="category-grid">
    <% 
        ...
        try {
            ...
            String query = "SELECT * FROM product WHERE category = 'Fashion'";
            rs = stmt.executeQuery(query);

            // Check if results are empty
            if (!rs.isBeforeFirst()) { // Checks if there are results
                out.println("<p>No products found in this category.</p>");
            } else {
